...
<body>
    <div id="resetParentDiv">
        ...
        <!-- <div class="resetChildDiv"> -->
            ...
            <form onsubmit="return resetPassword()" class="form" id="resetPassForm">
                <div id="inputForm">
                    <div id="part1">
                ...
                <div class="form-element" id="saveDetailsDiv">
                    <button type="submit" class="button-17" role="button" id="resetPassBtn">Submit</button>
                </div>
            </form>
        <!-- </div> -->
    </div>
    
    <script src="../controller/resetPassword.js"></script>
</body>
</html>